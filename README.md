...
Besides that, I'm also a stand-up comedian with a focus on crafting one-liner jokes. Let me share a humorous tidbit about my own name: You might be familiar with Jike Zhang, the renowned ping-pong player. Coincidentally, in computer networks, "ping" and "pong" are terms used to describe a mechanism for testing connectivity and response time between devices. So maybe I am also a ping-pong sender in a certain sense.
